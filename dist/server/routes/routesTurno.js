...
routes.post('/crearTurno', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nombre, apellido, dni, edad, fechaTurno, horaTurno, pacienteDB, error, pacienteEncontrado, paciente, fecha, turno, turnoDB;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, nombre = _a.nombre, apellido = _a.apellido, dni = _a.dni, edad = _a.edad, fechaTurno = _a.fechaTurno, horaTurno = _a.horaTurno;
                error = false;
            ...
            case 4:
                ...
                if (!utils_1.default.verify_date(fechaTurno, horaTurno)) return [3 /*break*/, 6];
